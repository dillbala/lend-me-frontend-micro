...
<form>
    ...
    <br>
    <input id="ex1" name = "ex1" data-slider-id='ex1Slider' type="text" data-slider-min="0" data-slider-max="1000" data-slider-step="500" data-slider-value="500"/>
    <br>
    </br>
    ...
    <br>
    <input id="ex2" name = "ex2" data-slider-id='ex2Slider' type="text" data-slider-min="1" data-slider-max="31" data-slider-step="1" data-slider-value="7"/>
    <br>
    </br>
